...
## Overview
This project explores customer churn behavior in a telecom company using data-driven analysis. The main goal is to understand why customers leave and identify patterns that can help improve customer retention. Rather than focusing only on numbers, this analysis emphasizes customer behavior, lifecycle patterns, and business impact.

## Objectives
1. Measure overall churn rate
2. Identify key drivers of churn
3. Understand customer behavior across lifecycle stages
4. Provide actionable recommendations to reduce churn

## Tools Used
1. Python (Pandas) → Data cleaning & preparation
2. SQL (MySQL) → Data aggregation & analytical queries
...
1. Converted data types (e.g., TotalCharges to numeric)
2. Handled missing values
3. Verified data consistency
4. Exported clean dataset for SQL and visualization
...
Customers are most likely to churn within their first ~17–20 months. This period represents a high-risk churn window, where customers are still forming their perception of value.
...
2. Monitor high-paying customers more closely
3. Introduce early retention strategies (first 6–12 months)
4. Provide value-based pricing or bundled services
...
## Conclusion
This analysis highlights that churn is not random — it follows clear behavioral patterns. The most critical takeaway is that early-stage customers are the most at risk, and improving their experience can significantly reduce churn.
